        ...
        <div class="container">
            ...
            <div class="slider-container has-scrollbar">
                ...
                <div class="slider-item">
                    <img src="{{ asset('images/day.jpg') }}" alt="women's latest fashion sale" class="banner-img">
                    ...
                    <div class="banner-content">
                        ...
                        <!-- <h2 class="banner-title">fashion sale</h2> -->
                    ...
                    <ul class="sidebar-menu-category-list">
                        ...
                        <li class="sidebar-menu-category">
                            ...
                            <button class="sidebar-accordion-menu" data-accordion-btn>
                                ...
                                <div class="menu-title-flex">
                                    <img src="{{ asset('images/icons/dress.svg') }}" alt="clothes" width="20"
                        ...
                        <li class="sidebar-menu-category">
                            ...
                            <button class="sidebar-accordion-menu" data-accordion-btn>
                                ...
                                <div class="menu-title-flex">
                                    <img src="{{ asset('images/icons/shoes.svg') }}" alt="footwear"
                        ...
                        <li class="sidebar-menu-category">
                            ...
                            <button class="sidebar-accordion-menu" data-accordion-btn>
                                ...
                                <div class="menu-title-flex">
                                    <img src="{{ asset('images/icons/jewelry.svg') }}" alt="clothes"
                                        class="menu-title-img" width="20" height="20">
                        ...
                        <li class="sidebar-menu-category">
                            ...
                            <button class="sidebar-accordion-menu" data-accordion-btn>
                                ...
                                <div class="menu-title-flex">
                                    <img src="{{ asset('images/icons/perfume.svg') }}" alt="perfume"
                                        class="menu-title-img" width="20" height="20">
                        ...
                        <li class="sidebar-menu-category">
                            ...
                            <button class="sidebar-accordion-menu" data-accordion-btn>
                                ...
                                <div class="menu-title-flex">
                                    <img src="{{ asset('images/icons/glasses.svg') }}" alt="glasses"
                                        class="menu-title-img" width="20" height="20">
                        ...
                        <li class="sidebar-menu-category">
                            ...
                            <button class="sidebar-accordion-menu" data-accordion-btn>
                                ...
                                <div class="menu-title-flex">
                                    <img src="{{ asset('images/icons/bag.svg') }}" alt="bags" class="menu-title-img"
                                        width="20" height="20">
                        ...
                        <div class="showcase-wrapper has-scrollbar">
                            ...
                            <div class="showcase-container">
                                ...
                                <div class="showcase">
                                    ...
                                    <a href="#" class="showcase-img-box">
                                        <img src="{{ asset('images/products/clothes-1.jpg') }}"
                                ...
                                <div class="showcase">
                                    ...
                                    <a href="#" class="showcase-img-box">
                                        <img src="{{ asset('images/products/clothes-2.jpg') }}"
                                ...
                                <div class="showcase">
                                    ...
                                    <a href="#" class="showcase-img-box">
                                        <img src="{{ asset('images/products/clothes-3.jpg') }}"
                                ...
                                <div class="showcase">
                                    ...
                                    <a href="#" class="showcase-img-box">
                                        <img src="{{ asset('images/products/shirt-1.jpg') }}"
                            ...
                            <div class="showcase-container">
                                ...
                                <div class="showcase">
                                    ...
                                    <a href="#" class="showcase-img-box">
                                        <img src="{{ asset('images/products/jacket-5.jpg') }}"
                                ...
                                <div class="showcase">
                                    ...
                                    <a href="#" class="showcase-img-box">
                                        <img src="{{ asset('images/products/jacket-1.jp') }}"
                                ...
                                <div class="showcase">
                                    ...
                                    <a href="#" class="showcase-img-box">
                                        <img src="{{ asset('images/products/jacket-3.jpg') }}"
                                            alt="mens winter leathers jackets" class="showcase-img" width="70">
                                ...
                                <div class="showcase">
                                    ...
                                    <a href="#" class="showcase-img-box">
                                        <img src="{{ asset('images/products/shorts-1.jpg') }}"
                        ...
                        <div class="showcase-wrapper  has-scrollbar">
                            ...
                            <div class="showcase-container">
                                ...
                                <div class="showcase">
                                    ...
                                    <a href="#" class="showcase-img-box">
                                        <img src="{{ asset('images/products/sports-1.jpg') }}"
                                ...
                                <div class="showcase">
                                    ...
                                    <a href="#" class="showcase-img-box">
                                        <img src="{{ asset('images/products/sports-2.jpg') }}"
                                ...
                                <div class="showcase">
                                    ...
                                    <a href="#" class="showcase-img-box">
                                        <img src="{{ asset('images/products/party-wear-1.jpg') }}"
                                ...
                                <div class="showcase">
                                    ...
                                    <a href="#" class="showcase-img-box">
                                        <img src="{{ asset('images/products/sports-3.jpg') }}"
                            ...
                            <div class="showcase-container">
                                ...
                                <div class="showcase">
                                    ...
                                    <a href="#" class="showcase-img-box">
                                        <img src="{{ asset('images/products/sports-6.jpg') }}"
                                ...
                                <div class="showcase">
                                    ...
                                    <a href="#" class="showcase-img-box">
                                        <img src="{{ asset('images/products/shoe-3.jpg') }}"
                                ...
                                <div class="showcase">
                                    ...
                                    <a href="#" class="showcase-img-box">
                                        <img src="{{ asset('images/products/shoe-1.jpg') }}"
                                ...
                                <div class="showcase">
                                    ...
                                    <a href="#" class="showcase-img-box">
                                        <img src="{{ asset('images/products/shoe-2.jpg') }}"
                        ...
                        <div class="showcase-wrapper  has-scrollbar">
                            ...
                            <div class="showcase-container">
                                ...
                                <div class="showcase">
                                    ...
                                    <a href="#" class="showcase-img-box">
                                        <img src="{{ asset('images/products/watch-3.jpg') }}"
                                ...
                                <div class="showcase">
                                    ...
                                    <a href="#" class="showcase-img-box">
                                        <img src="{{ asset('images/products/jewellery-3.jpg') }}"
                                ...
                                <div class="showcase">
                                    ...
                                    <a href="#" class="showcase-img-box">
                                        <img src="{{ asset('images/products/perfume.jpg') }}"
                                ...
                                <div class="showcase">
                                    ...
                                    <a href="#" class="showcase-img-box">
                                        <img src="{{ asset('images/products/belt.jpg') }}"
                            ...
                            <div class="showcase-container">
                                ...
                                <div class="showcase">
                                    ...
                                    <a href="#" class="showcase-img-box">
                                        <img src="{{ asset('images/products/jewellery-2.jpg') }}"
                                ...
                                <div class="showcase">
                                    ...
                                    <a href="#" class="showcase-img-box">
                                        <img src="{{ asset('images/products/watch-1.jpg') }}"
                                ...
                                <div class="showcase">
                                    ...
                                    <a href="#" class="showcase-img-box">
                                        <img src="{{ asset('images/products/jewellery-1.jpg') }}"
                    ...
                    <div class="product-grid">
                        ...
                        <div class="showcase">
                            ...
                            <div class="showcase-banner">
                                ...
                                <img src="{{ asset('images/products/jacket-4.jpg') }}"
                        ...
                        <div class="showcase">
                            ...
                            <div class="showcase-banner">
                                ...
                                <img src="{{ asset('images/products/shirt-2.jpg') }}"
                        ...
                        <div class="showcase">
                            ...
                            <div class="showcase-banner">
                                ...
                                <img src="{{ asset('images/products/jacket-6.jpg') }}"
                        ...
                        <div class="showcase">
                            ...
                            <div class="showcase-banner">
                                ...
                                <img src="{{ asset('images/products/clothes-4.jpg') }}"
                        ...
                        <div class="showcase">
                            ...
                            <div class="showcase-banner">
                                <img src="{{ asset('images/products/shoe-2.jpg') }}" alt="Casual Men's Brown shoes"
                                    class="product-img default" width="300">
                                <img src="{{ asset('images/products/shoe-2_1.jpg') }}" alt="Casual Men's Brown shoes"
                        ...
                        <div class="showcase">
                            ...
                            <div class="showcase-banner">
                                <img src="{{ asset('images/products/watch-3.jpg') }}" alt="Pocket Watch Leather Pouch"
                                    class="product-img default" width="300">
                                <img src="{{ asset('images/products/watch-4.jpg') }}" alt="Pocket Watch Leather Pouch"
                                    class="product-img hover" width="300">
                        ...
                        <div class="showcase">
                            ...
                            <div class="showcase-banner">
                                <img src="{{ asset('images/products/watch-1.jpg') }}" alt="Smart watche Vital Plus"
                                    class="product-img default" width="300">
                                <img src="{{ asset('images/products/watch-2.jpg') }}" alt="Smart watche Vital Plus"
                                    class="product-img hover" width="300">
                        ...
                        <div class="showcase">
                            ...
                            <div class="showcase-banner">
                                <img src="{{ asset('images/products/party-wear-1.jpg') }}" alt="Womens Party Wear Shoes"
                                    class="product-img default" width="300">
                                <img src="{{ asset('images/products/party-wear-2.jpg') }}" alt="Womens Party Wear Shoes"
                                    class="product-img hover" width="300">
                        ...
                        <div class="showcase">
                            ...
                            <div class="showcase-banner">
                                <img src="{{ asset('images/products/jacket-1.jpg') }}"
                                    alt="Mens Winter Leathers Jackets" class="product-img default" width="300">
                                <img src="{{ asset('images/products/jacket-2.jpg') }}"
                        ...
                        <div class="showcase">
                            ...
                            <div class="showcase-banner">
                                ...
                                <img src="{{ asset('images/products/sports-4.jpg') }}"
                        ...
                        <div class="showcase">
                            ...
                            <div class="showcase-banner">
                                ...
                                <img src="{{ asset('images/products/shoe-1_1.jpg') }}"
                        ...
                        <div class="showcase">
                            ...
                            <div class="showcase-banner">
                                <img src="{{ asset('images/products/shorts-1.jpg') }}"
                                    ...
                                    width="300">
                                <img src="{{ asset('images/products/shorts-2.jpg') }}"
