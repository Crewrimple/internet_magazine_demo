      ...
      <li class="menu-category">
        ...
        <div class="dropdown-panel">
          ...
          <ul class="dropdown-panel-list">
            ...
            <li class="panel-list-item">
              <a href="#">
              <img src="{{asset('images/electronics-banner-1.jpg')}}" alt="headphone collection" width="250" height="119">
              <!-- <img src="{{ asset('public/images/electronics-banner-1.jpg') }}" alt="headphone collection" width="250" height="119">"> -->
